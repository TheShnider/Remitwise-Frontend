...
describe('Insurance Cached Wrapper', () => {
  ...
  describe('getActivePolicies', () => {
    it('should return active policies', async () => {
      const result = await insuranceCached.getActivePolicies('GABC1234567890123456789012345678901234567890123456789011');
    ...
    it('should cache results', async () => {
      const originalModule = await import('@/lib/contracts/insurance');
      const address = 'GABC1234567890123456789012345678901234567890123456789011';
    ...
    it('should preserve INVALID_ADDRESS errors', async () => {
      ...
      await expect(
        insuranceCached.getActivePolicies('GABC1234567890123456789012345678901234567890123456789011')
  ...
  describe('getTotalMonthlyPremium', () => {
    it('should return total premium', async () => {
      const result = await insuranceCached.getTotalMonthlyPremium('GABC1234567890123456789012345678901234567890123456789011');
    ...
    it('should validate premium is a valid number', async () => {
      ...
      await expect(
        insuranceCached.getTotalMonthlyPremium('GABC1234567890123456789012345678901234567890123456789011')
